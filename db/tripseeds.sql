...
VALUES 
 ((select id from users where userName = 'Chi Lu'),(select id from users where userName = 'Alex Ratliff'),'Coliseum, Oakland','Oakland','Ferry Building, San Francisco','San Francisco', '2017-08-04 14:00:00', 3),
 ((select id from users where userName = 'Anish Dabade'),(select id from users where userName = 'Eri Nagase'),'Oracle Arena, Oakland','Oakland','Ferry Building, San Francisco','San Francisco', '2017-08-04 14:00:00',4),
 ((select id from users where userName = 'Eri Nagase'),(select id from users where userName = 'Alex Ratliff'),'Lake Merritt, Oakland','Oakland','Fisherman\'s Wharf, San Francisco','San Francisco', '2017-08-04 14:00:00',5),
